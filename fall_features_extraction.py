...
# input : array (#frame, #landmarks, #coordonnees)


# output : array (#frame, #features, acceleration (#coordonnees), vitesse (#coordonnees), etat)
# landmarks selectionnes : nez, centre épaules, centre hanche, ankle droite, ankle gauche, poignet droite, poignet gauche
